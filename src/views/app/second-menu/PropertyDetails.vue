    ...
    <b-row>
        <b-colxx xxs="12">
            ...
            <div class="top-right-button-container">
                <b-button id="ddown5" size="lg" variant="outline-primary" class="top-right-button top-right-button-single" no-fade="true" @click="navigateBack()"><i class="iconsminds-arrow-back"/>{{$t('pages.back')}}</b-button>
            </div>
            <piaf-breadcrumb />
...
export default {
  ...
  created() {
    ...
    this.propertyID = new URLSearchParams(uri);
